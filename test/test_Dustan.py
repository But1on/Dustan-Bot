import pytest
from Dustan_t import correct_rait
from Dustan_t import super_sorted
from Dustan_t import super_join
...
def test_super_join():
    assert super_join(['0','1','2','3','4','5','6'],'10') == '1 - 10 - 5 - 6'
    assert super_join(['nasa','asa','dasa','oppo','yt','er','fdf'],'15') == 'asa - 15 - er - fdf'
    assert super_join(['a','b','c','d','e','f','t'],'20') == 'b - 20 - f - t'
